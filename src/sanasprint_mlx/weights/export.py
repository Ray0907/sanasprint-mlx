    ...
    readme.write_text(
        "\n".join(
            [
                ...
                "## Usage",
                "",
                "Install the runtime from GitHub first:",
                "",
                "```bash",
                "python3 -m pip install git+https://github.com/Ray0907/sanasprint-mlx.git",
                "```",
                "",
                ...
                "## Prompt Notes",
                "",
                "The underlying SanaSprint model follows English visual prompts best. Traditional Chinese prompts can work, "
                "but mixed prompts with English visual keywords are more reliable for specific materials, lighting, and scene details.",
                "",
                "## Scope",
                "",
                "Supported:",
