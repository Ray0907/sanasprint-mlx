...
This checked-in image was generated by the real Diffusers `SanaSprintPipeline` reference path on local Apple Silicon MPS. It is kept as a stable baseline artifact. Current native MLX outputs and measurements are listed in the Generate CLI section below.
